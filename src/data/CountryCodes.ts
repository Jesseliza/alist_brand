export const countryCodes = [
  ...
  { name: 'American Samoa(+1)', code: '+1' },
  { name: 'Andorra(+376)', code: '+376' },
  { name: 'Angola(+244)', code: '+244' },
  { name: 'Anguilla(+264)', code: '+264' },
  { name: 'Antarctica(+672)', code: '+672' },
  { name: 'Antigua & Barbuda(+268)', code: '+268' },
  ...
  { name: 'Cayman Islands(+345)', code: '+345' },
  ...
  { name: 'Congo - Brazzaville(+242)', code: '+242' },
  ...
  { name: 'Falkland Islands (Islas Malvinas)(+500)', code: '+500' },
  ...
  { name: 'Montserrat(+1)', code: '+1' },
  { name: 'Morocco(+212)', code: '+212' },
  { name: 'Mozambique(+258)', code: '+258' },
  { name: 'Myanmar (Burma)(+95)', code: '+95' },
  ...
  { name: 'Northern Mariana Islands(+670)', code: '+670' },
  { name: 'Norway(+47)', code: '+47' },
  { name: 'Oman(+968)', code: '+968' },
  { name: 'Pakistan(+92)', code: '+92' },
  { name: 'Palau(+680)', code: '+680' },
  { name: 'Palestine(+230)', code: '+230' },
  { name: 'Palestinian Territory, Occupied(+970)', code: '+970' },
  ...
  { name: 'Saint Vincent and The Grenadines(+1)', code: '+1' },
  { name: 'San Marino(+378)', code: '+378' },
  { name: 'São Tomé & Príncipe(+685)', code: '+685' },
  ...
  { name: 'South Georgia and The South Sandwich Islands(+500)', code: '+500' },
  { name: 'South Korea(+82)', code: '+82' },
  { name: 'Spain(+34)', code: '+34' },
  { name: 'Sri Lanka(+94)', code: '+94' },
  { name: 'St. Kitts & Nevis(+869)', code: '+869' },
  { name: 'St. Vincent & Grenadines(+508)', code: '+508' },
  { name: 'St.Helena(+290)', code: '+290' },
  { name: 'St.Lucia(+758)', code: '+758' },
  ...
  { name: 'Tanzania(+47)', code: '+47' },
  { name: 'Tanzania, United Republic of(+255)', code: '+255' },
  { name: 'Thailand(+66)', code: '+66' },
  { name: 'The Central African Republic(+236)', code: '+236' },
  { name: 'Togo(+228)', code: '+228' },
  { name: 'Tokelau(+690)', code: '+690' },
  { name: 'Tonga(+676)', code: '+676' },
  { name: 'Trinidad & Tobago(+868)', code: '+868' },
  ...
  { name: 'Virgin Islands-British(+1)', code: '+1' },
  { name: 'Virgin Islands-US(+1)', code: '+1' },
  { name: 'Wallis & Futuna(+1)', code: '+1' },
