...
import { adaptDedicatedOfferSummaryToDisplay } from "@/utils/dedicated-offerAdapters";
...
export default function DedicatedOffersPage() {
  ...
  const handleAddDedicatedOfferClick = () => {
    ...
    console.log("Add DedicatedOffer clicked");
  };
  ...
  const handleCheckboxChange = (dedicated-offerId: string) => {
    setCheckedRows((prevCheckedRows) => {
      const newCheckedRows = new Set(prevCheckedRows);
      if (newCheckedRows.has(dedicated-offerId)) {
        newCheckedRows.delete(dedicated-offerId);
      } else {
        newCheckedRows.add(dedicated-offerId);
      }
  ...
  const displayDedicatedOffers = dedicated-offers.map(adaptDedicatedOfferSummaryToDisplay);
            ...
            <>
              <div className="md:hidden">
                {displayDedicatedOffers.length === 0 && !loading ? (
                  ...
                  displayDedicatedOffers.map((dedicated-offer) => (
                    <div key={dedicated-offer.id} className="mb-4">
                      <Link href={`/businesses/dedicated-offers/${dedicated-offer.id}`}>
                        <DedicatedOfferMobileCard dedicated-offer={dedicated-offer} />
                      </Link>
                    </div>
                  ))
                )}
                ...
                {view === "table" ? (
                  <>
                    <DedicatedOffersTable
                      dedicated-offers={displayDedicatedOffers}
                        ...
                        displayDedicatedOffers.map((dedicated-offer) => (
                          ...
                          >
                            <DedicatedOfferCard
                              ...
                              onCheckboxChange={() =>
                                handleCheckboxChange(dedicated-offer.id.toString())
                              }
