  ...
  try {
    ...
    if ('Venue' in response && response.Venue) {
      ...
      const feBrand: Brand = {
        ...
        companyName: apiBrand.company_name || null,
        country: apiBrand.country_id ? apiBrand.country_id.toString() : null,
        state: apiBrand.state_id ? apiBrand.state_id.toString() : null,
        businessLocation: apiBrand.delivery_areas || null,
        tradeLicenseCopy: apiBrand.trade_license_file || null,
        vatCertificate: apiBrand.vat_certificate_file || null,
        instagramHandle: apiBrand.venue_instagram_url || null,
        associateName: apiBrand.Venue_contact_name || null,
        associateEmail: apiBrand.venue_email,
        associatePhone: apiBrand.venue_contact_number || null,
        associateFirstName: '',
        associateLastName: '',
        associateInitials: '',
        associateBackground: '',
        Venue_contact_name: apiBrand.Venue_contact_name,
