...
import CardView from "../CardView"; // Adjust the import path as needed
...
const CardGroupView = ({ activeAddons, updateAddonsGrandParentMain }) => {
  ...
  const updateAddonsParent = (id) => {
    console.log(id);
    updateAddonsGrandParentMain(id);
  };
    ...
    <div className="ts-addons-card-group">
      {addons.map((addon, index) => (
        <CardView
          ...
          updateAddonsParent={updateAddonsParent}
        />
      ))}
    </div>
  );
