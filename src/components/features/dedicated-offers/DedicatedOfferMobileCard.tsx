...
export default function DedicatedOfferMobileCard({
  ...
  const getDedicatedOfferTypeDisplay = (type?: string) => {
    switch (type) {
      case "WalkIn":
        return "Walk in";
      case "Delivery":
      ...
      <div className="flex gap-5 items-center">
        <div className="relative w-[86.31px] h-[86.31px] rounded-[10px] overflow-hidden bg-[#E1E1E1]">
          <Image
            ...
            alt={title ?? "DedicatedOffer thumbnail"}
            fill
