...
import { DedicatedOffer, OfferUser } from "@/types/entities";
...
export default function Creators({ dedicated-offer }: { dedicated-offer: DedicatedOffer }) {
  ...
  const creators = dedicated-offer?.dedicated_offer?.offer_users || [];
  ...
  if (dedicated-offer?.is_dedicated !== 1) {
    return (
