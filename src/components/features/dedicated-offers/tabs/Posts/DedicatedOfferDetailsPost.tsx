...
interface DedicatedOfferDetailsPostProps {
...
export default function DedicatedOfferDetailsPost({
  authorImage,
  authorName,
  instagramUsername,
  stats,
  postImages,
}: DedicatedOfferDetailsPostProps) {
      ...
      <article className="max-w-[412px] rounded-[13px] md:shadow-[0_0_4px_rgba(0,0,0,0.16)] p-4">
        ...
        <div className="mt-[7.7px] text-center">
          ...
          <div className="flex items-center gap-[5.7]px justify-center">
            <Image
              src="/icons/dedicated-offer/details/creators-and-posts/instagram.svg"
              alt="Instagram"
              width={8.83}
              height={8.83}
            />
