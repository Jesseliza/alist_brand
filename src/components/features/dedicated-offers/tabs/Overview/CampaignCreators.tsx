...
interface DedicatedOfferCreatorsProps {
...
export default function DedicatedOfferCreators({ dedicated-offer }: DedicatedOfferCreatorsProps) {
  const approvedCreators =
    dedicated-offer.dedicated_offer?.offer_users.filter(
