...
import { DedicatedOfferAvailability } from "@/types/entities/dedicated-offer";
import YearMonthPicker from "@/components/general/YearMonthPicker";

export default function Availabilites({ dedicated-offerId }: { dedicated-offerId: string }) {
  const [currentDate, setCurrentDate] = useState(new Date());
  const [selectedAvailabilities, setSelectedAvailabilities] =
    useState<DedicatedOfferAvailability[] | null>(null);
  ...
  const handleDaySelect = (availabilities: DedicatedOfferAvailability[]) => {
  ...
  return (
    <div>
      <div className="max-w-[1021px] mx-auto py-[54px]">
        ...
        <div>
          <MonthCalendar
            dedicated-offerId={dedicated-offerId}
