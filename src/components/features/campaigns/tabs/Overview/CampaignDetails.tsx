  ...
  const campaignCards = [
    {
      ...
      imgHeight: 19.47,
      imgHeightMobile: 32,
      text: campaign.campaignDetails.walkIn,
    },
    {
      ...
      text: campaign.campaignDetails.barter,
    },
    {
      ...
      text: campaign.campaignDetails.price,
    },
    {
      ...
      text: campaign.campaignDetails.approval,
    },
    {
    ...
    },
    {
      ...
      text: campaign.campaignDetails.date,
    },
  ];
