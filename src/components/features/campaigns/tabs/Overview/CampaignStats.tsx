  ...
  const statCards = [
    {
      ...
      imgWidth: 47.27,
      imgHeight: 33.09,
      title: campaign.campaignStats.creators.toString(),
      subtitle: "Creators",
    },
    {
      ...
      imgWidth: 31.11,
      imgHeight: 27.69,
      title: formatNumber(campaign.campaignStats.impressions),
    ...
    },
    {
      ...
      imgWidth: 38.62,
      imgHeight: 37.87,
      title: formatNumber(campaign.campaignStats.reach),
      subtitle: "Reach",
    },
    {
      ...
      imgWidth: 32,
      imgHeight: 31.57,
      title: campaign.campaignStats.posts.toString(),
      subtitle: "Posts",
    },
    {
      ...
      imgWidth: 34.48,
      imgHeight: 34.48,
      title: campaign.campaignStats.reviews.toString(),
      subtitle: "Reviews",
    },
  ];
